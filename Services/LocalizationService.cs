    ...
    private LocalizationService()
    {
        _translations = new Dictionary<string, Dictionary<string, string>>
        {
            ["Русский"] = new Dictionary<string, string>
            {
                ...
                // Адрес / Яндекс.Карты
                ["Loc_AddPlace"]         = "📍 Добавить место",
                ["Loc_EnterAddress"]     = "Введите адрес...",
                ["Loc_OpenInMaps"]       = "Открыть на Яндекс.Картах",
                ["Loc_ClearAddress"]     = "Очистить",
                ["Loc_NoApiKeys"]        = "Введите адрес как текст. Для подсказок и карты — добавьте API-ключи Яндекс.Карт в настройках.",
                ["Maps_IntegrTitle"]     = "Интеграции",
                ["Maps_YandexTitle"]     = "🗺 Яндекс.Карты",
                ["Maps_YandexSub"]       = "Подсказки адресов, статическая карта и геокодирование",
                ["Maps_SuggestKey"]      = "Ключ Suggest API:",
                ["Maps_GeocoderKey"]     = "Ключ Geocoder API:",
                ["Maps_StaticKey"]       = "Ключ Static API:",
                ["Maps_GetKeysLink"]     = "Где получить ключи?",
                ["Maps_SaveKeys"]        = "Сохранить ключи",
                ["Maps_KeysSaved"]       = "Ключи сохранены",

                // ── Фоновые звуки (Промпт 7) ─────────────────────────────
                ["Sound_Title"]          = "Фоновые звуки",
                ["Sound_Play"]           = "Воспроизвести",
                ["Sound_Pause"]          = "Пауза",
                ["Sound_AddOwn"]         = "+ Добавить свой",
                ["Sound_MixPomodoro"]    = "Микс с Помодоро",
                ["Sound_MixPomodoroTip"] = "Звуки включаются автоматически во время рабочих интервалов",
                ["Sound_MasterVolume"]   = "Общая громкость",
                ["Sound_IndivVolumes"]   = "Индивидуальные",
                ["Sound_DeleteConfirm"]  = "Удалить этот звук?",
                ["Sound_Rename"]         = "Переименовать",
                ["Sound_Delete"]         = "Удалить",
                ["Sound_NoFile"]         = "Файл не найден",
                ["Sound_ManageSounds"]   = "Управление звуками",
                ["Sound_ChooseIcon"]     = "Иконка",
                ["Sound_SoundName"]      = "Название",
                ["Sound_AddConfirm"]     = "Добавить",
                ["sound.rain"]           = "Дождь",
                ["sound.forest"]         = "Лес",
                ["sound.ocean"]          = "Океан",
                ["sound.fire"]           = "Костёр",
                ["sound.white_noise"]    = "Белый шум",
                ["sound.cafe"]           = "Кафе",
                ["sound.keyboard"]       = "Клавиатура",
                ["sound.night"]          = "Ночь",

                // ── Трекер медиа (Промпт 8) ───────────────────────────
                ["Media_Title"]          = "Медиатека",
                ["Media_AddBtn"]         = "+ Добавить",
                ["Media_EditBtn"]        = "Редактировать",
                ["Media_DeleteBtn"]      = "Удалить",
                ["Media_SaveBtn"]        = "Сохранить",
                ["Media_CancelBtn"]      = "Отмена",
                ["Media_DeleteConfirm"]  = "Удалить эту запись?",
                ["Media_All"]            = "Все",
                ["Media_Movie"]          = "Фильм",
                ["Media_Series"]         = "Сериал",
                ["Media_Anime"]          = "Аниме",
                ["Media_Book"]           = "Книга",
                ["Media_Manga"]          = "Манга",
                ["Media_Planned"]        = "Запланировано",
                ["Media_InProgress"]     = "Смотрю / Читаю",
                ["Media_Completed"]      = "Завершено",
                ["Media_Dropped"]        = "Брошено",
                ["Media_SearchHint"]     = "Поиск по названию…",
                ["Media_SortDate"]       = "По дате добавления",
                ["Media_SortCompleted"]  = "По дате завершения",
                ["Media_SortScore"]      = "По оценке",
                ["Media_SortTitle"]      = "По названию",
                ["Media_SortYear"]       = "По году",
                ["Media_TypeTitle"]      = "Тип",
                ["Media_YearTitle"]      = "Год",
                ["Media_DirectorTitle"]  = "Режиссёр",
                ["Media_AuthorTitle"]    = "Автор",
                ["Media_ArtistTitle"]    = "Художник",
                ["Media_DurationTitle"]  = "Длительность",
                ["Media_EpisodesTitle"]  = "Эпизоды",
                ["Media_SeasonsTitle"]   = "Сезоны",
                ["Media_PagesTitle"]     = "Страниц",
                ["Media_ChaptersTitle"]  = "Глав",
                ["Media_VolumesTitle"]   = "Томов",
                ["Media_GenresTitle"]    = "Жанры",
                ["Media_DescTitle"]      = "Описание",
                ["Media_StatusTitle"]    = "Статус",
                ["Media_ScorePlot"]      = "Сюжет",
                ["Media_ScoreVisual"]    = "Визуал",
                ["Media_ScoreStyle"]     = "Стиль написания",
                ["Media_ScorePersonal"]  = "Насколько понравилось",
                ["Media_OverallScore"]   = "Итоговая оценка",
                ["Media_PersonalNote"]   = "Личное мнение",
                ["Media_SourceTitle"]    = "Источник",
                ["Media_StartedAt"]      = "Начато",
                ["Media_CompletedAt"]    = "Завершено",
                ["Media_Season"]         = "Сезон",
                ["Media_AddSeason"]      = "Добавить сезон",
                ["Media_EpisodeSec"]     = "Эпизоды",
                ["Media_ChapterSec"]     = "Главы",
                ["Media_ProgressSec"]    = "Прогресс чтения",
                ["Media_RatingsSec"]     = "Оценка",
                ["Media_MarkAll"]        = "Отметить все",
                ["Media_MarkUpTo"]       = "Отметить до этого",
                ["Media_FinishBook"]     = "Я закончил",
                ["Media_NoPoster"]       = "Нет постера",
                ["Media_PosterFile"]     = "Загрузить файл",
                ["Media_PosterUrl"]      = "Вставить URL",
                ["Media_IsOngoing"]      = "Сериал продолжается",
                ["Media_ChooseType"]     = "Выберите тип",
                ["Media_Step1Title"]     = "Тип медиа",
                ["Media_Step2Title"]     = "Информация",
                ["Media_OrigTitle"]      = "Оригинальное название",
                ["Media_Country"]        = "Страна",
                ["Media_ISBN"]           = "ISBN",
                ["Media_Source_Netflix"] = "Netflix",
                ["Media_Source_Kino"]    = "Кинопоиск",
                ["Media_Source_Amedia"]  = "Amediateka",
                ["Media_Source_Paper"]   = "Бумажная книга",
                ["Media_Source_Ebook"]   = "Электронная",
                ["Media_Source_Audio"]   = "Аудио",
                ["Media_Source_Cinema"]  = "Кинотеатр",
                ["Media_Source_Other"]   = "Другое",
                ["Media_StatTotal"]      = "Всего записей",
                ["Media_StatYear"]       = "Завершено в этом году",
                ["Media_StatPlanned"]    = "В планах",
                ["Media_StatDropped"]    = "Брошено",
                ["Media_StatHours"]      = "Часов просмотра",
                ["Media_StatTopRated"]   = "Топ оценок",
                ["Media_StatByType"]     = "По типам",
                ["Media_StatGenre"]      = "Любимый жанр",
                ["Media_StatTopGenres"]  = "Топ жанров",
                ["Media_OverallManual"]  = "вручную",
                ["Media_ShowMore"]       = "Показать ещё",
                ["Media_ShowLess"]       = "Свернуть",
                ["Media_AutoComplete"]   = "Отметить как завершённый?",
                ["Media_MinShort"]       = "мин",
                ["Media_EpShort"]        = "эп.",
                ["Media_PageShort"]      = "стр.",
                ["Media_Empty"]          = "Список пуст. Нажмите «+ Добавить»",

                // ── Годовая статистика (Промпт 10) ───────────────────────
                ["YearSummary_Title"]          = "Итоги {0} года",
                ["YearSummary_TabYear"]        = "Год",
                ["YearSummary_TabWeek"]        = "Неделя",
                ["YearSummary_ExportPdf"]      = "Экспорт PDF",
                ["YearSummary_ExportPng"]      = "Экспорт PNG",
                ["YearSummary_YearInActions"]  = "Год в действиях",
                ["YearSummary_HeatLess"]       = "Меньше",
                ["YearSummary_HeatMore"]       = "Больше",
                ["YearSummary_CardTasks"]      = "Задачи",
                ["YearSummary_CardFocus"]      = "Фокус",
                ["YearSummary_CardEvents"]     = "События",
                ["YearSummary_CardHabits"]     = "Привычки",
                ["YearSummary_CardWorkouts"]   = "Тренировки",
                ["YearSummary_CardMood"]       = "Настроение",
                ["YearSummary_CardNotes"]      = "Заметки",
                ["YearSummary_CardMedia"]      = "Медиа",
                ["YearSummary_Created"]        = "Создано",
                ["YearSummary_Completed"]      = "Выполнено",
                ["YearSummary_CompPct"]        = "% выполнения",
                ["YearSummary_TopProjects"]    = "Топ проекты",
                ["YearSummary_TotalHours"]     = "Всего часов",
                ["YearSummary_AvgPerDay"]      = "Среднее в день",
                ["YearSummary_BestDay"]        = "Лучший день",
                ["YearSummary_BestMonth"]      = "Лучший месяц",
                ["YearSummary_ActiveHabits"]   = "Активных привычек",
                ["YearSummary_LongestStreak"]  = "Макс. серия",
                ["YearSummary_AvgPct"]         = "Средний % выполнения",
                ["YearSummary_TopStable"]      = "Самые стабильные",
                ["YearSummary_Sessions"]       = "Тренировок",
                ["YearSummary_Tonnage"]        = "Тоннаж",
                ["YearSummary_Favorite"]       = "Любимое упражнение",
                ["YearSummary_TotalRecords"]   = "Всего записей",
                ["YearSummary_GreenMonth"]     = "Самый «зелёный» месяц",
                ["YearSummary_DaysWithNotes"]  = "Дней с записями",
                ["YearSummary_TopTags"]        = "Топ теги",
                ["YearSummary_CompletedYear"]  = "Завершено в {0} году",
                ["YearSummary_AvgScore"]       = "Средняя оценка",
                ["YearSummary_TopRated"]       = "Топ по оценке",
                ["YearSummary_NoData"]         = "Нет данных за этот год",
                ["YearSummary_Days"]           = "дн.",
                ["YearSummary_Tons"]           = "т",
                ["YearSummary_Hours"]          = "ч",
                ["YearSummary_Hph"]            = "ч/д",
                ["YearSummary_Of365"]          = "из {0}",
                // День в деталях
                ["DayStats_Title"]             = "В этот день",
                ["DayStats_Tasks"]             = "✅ Задачи",
                ["DayStats_Habits"]            = "🔥 Привычки",
                ["DayStats_Events"]            = "📅 События",
                ["DayStats_Pomodoro"]          = "⏱ Помодоро",
                ["DayStats_Workout"]           = "🏋 Тренировка",
                ["DayStats_Mood"]              = "😊 Настроение",
                ["DayStats_Note"]              = "📝 Заметка",
                ["DayStats_Close"]             = "Закрыть",
                ["DayStats_NoData"]            = "В этот день активности не обнаружено",
                ["DayStats_Sessions"]          = "сессий",
                ["DayStats_Exercises"]         = "упражнений",
                ["DayStats_Done"]              = "выполнено",
                ["DayStats_Of"]               = "из",
                // Настроение уровни
                ["Mood_Level1"] = "Ужасно",
                ["Mood_Level2"] = "Плохо",
                ["Mood_Level3"] = "Нейтрально",
                ["Mood_Level4"] = "Хорошо",
                ["Mood_Level5"] = "Супер"
            },
            ["English"] = new Dictionary<string, string>
            {
                ...
                // Address / Yandex Maps
                ["Loc_AddPlace"]         = "📍 Add location",
                ["Loc_EnterAddress"]     = "Enter address...",
                ["Loc_OpenInMaps"]       = "Open in Yandex Maps",
                ["Loc_ClearAddress"]     = "Clear",
                ["Loc_NoApiKeys"]        = "Enter address as text. For suggestions and map — add Yandex Maps API keys in settings.",
                ["Maps_IntegrTitle"]     = "Integrations",
                ["Maps_YandexTitle"]     = "🗺 Yandex Maps",
                ["Maps_YandexSub"]       = "Address suggestions, static map and geocoding",
                ["Maps_SuggestKey"]      = "Suggest API key:",
                ["Maps_GeocoderKey"]     = "Geocoder API key:",
                ["Maps_StaticKey"]       = "Static API key:",
                ["Maps_GetKeysLink"]     = "Where to get keys?",
                ["Maps_SaveKeys"]        = "Save keys",
                ["Maps_KeysSaved"]       = "Keys saved",

                // ── Background Sounds (Prompt 7) ──────────────────────────
                ["Sound_Title"]          = "Background Sounds",
                ["Sound_Play"]           = "Play",
                ["Sound_Pause"]          = "Pause",
                ["Sound_AddOwn"]         = "+ Add custom",
                ["Sound_MixPomodoro"]    = "Mix with Pomodoro",
                ["Sound_MixPomodoroTip"] = "Sounds play automatically during work intervals",
                ["Sound_MasterVolume"]   = "Master volume",
                ["Sound_IndivVolumes"]   = "Individual",
                ["Sound_DeleteConfirm"]  = "Delete this sound?",
                ["Sound_Rename"]         = "Rename",
                ["Sound_Delete"]         = "Delete",
                ["Sound_NoFile"]         = "File not found",
                ["Sound_ManageSounds"]   = "Manage sounds",
                ["Sound_ChooseIcon"]     = "Icon",
                ["Sound_SoundName"]      = "Name",
                ["Sound_AddConfirm"]     = "Add",
                ["sound.rain"]           = "Rain",
                ["sound.forest"]         = "Forest",
                ["sound.ocean"]          = "Ocean",
                ["sound.fire"]           = "Fire",
                ...
                // ── Media Tracker (Prompt 8) ──────────────────────────
                ["Media_Title"]          = "Media Library",
                ["Media_AddBtn"]         = "+ Add",
                ["Media_EditBtn"]        = "Edit",
                ["Media_DeleteBtn"]      = "Delete",
                ["Media_SaveBtn"]        = "Save",
                ["Media_CancelBtn"]      = "Cancel",
                ["Media_DeleteConfirm"]  = "Delete this entry?",
                ["Media_All"]            = "All",
                ["Media_Movie"]          = "Movie",
                ["Media_Series"]         = "Series",
                ["Media_Anime"]          = "Anime",
                ...
                ["Media_InProgress"]     = "Watching / Reading",
                ["Media_Completed"]      = "Completed",
                ["Media_Dropped"]        = "Dropped",
                ["Media_SearchHint"]     = "Search by title…",
                ["Media_SortDate"]       = "By date added",
                ["Media_SortCompleted"]  = "By date completed",
                ["Media_SortScore"]      = "By score",
                ["Media_SortTitle"]      = "By title",
                ["Media_SortYear"]       = "By year",
                ["Media_TypeTitle"]      = "Type",
                ["Media_YearTitle"]      = "Year",
                ["Media_DirectorTitle"]  = "Director",
                ["Media_AuthorTitle"]    = "Author",
                ["Media_ArtistTitle"]    = "Artist",
                ["Media_DurationTitle"]  = "Duration",
                ["Media_EpisodesTitle"]  = "Episodes",
                ["Media_SeasonsTitle"]   = "Seasons",
                ["Media_PagesTitle"]     = "Pages",
                ["Media_ChaptersTitle"]  = "Chapters",
                ["Media_VolumesTitle"]   = "Volumes",
                ["Media_GenresTitle"]    = "Genres",
                ["Media_DescTitle"]      = "Description",
                ["Media_StatusTitle"]    = "Status",
                ["Media_ScorePlot"]      = "Plot",
                ["Media_ScoreVisual"]    = "Visuals",
                ["Media_ScoreStyle"]     = "Writing style",
                ["Media_ScorePersonal"]  = "Personal enjoyment",
                ["Media_OverallScore"]   = "Overall score",
                ["Media_PersonalNote"]   = "Personal note",
                ["Media_SourceTitle"]    = "Source",
                ["Media_StartedAt"]      = "Started",
                ["Media_CompletedAt"]    = "Completed",
                ["Media_Season"]         = "Season",
                ["Media_AddSeason"]      = "Add season",
                ["Media_EpisodeSec"]     = "Episodes",
                ["Media_ChapterSec"]     = "Chapters",
                ["Media_ProgressSec"]    = "Reading progress",
                ["Media_RatingsSec"]     = "Ratings",
                ["Media_MarkAll"]        = "Mark all",
                ["Media_MarkUpTo"]       = "Mark up to here",
                ["Media_FinishBook"]     = "I finished it",
                ["Media_NoPoster"]       = "No poster",
                ["Media_PosterFile"]     = "Upload file",
                ["Media_PosterUrl"]      = "Paste URL",
                ["Media_IsOngoing"]      = "Still airing",
                ["Media_ChooseType"]     = "Choose type",
                ["Media_Step1Title"]     = "Media type",
                ["Media_Step2Title"]     = "Information",
                ["Media_OrigTitle"]      = "Original title",
                ["Media_Country"]        = "Country",
                ["Media_ISBN"]           = "ISBN",
                ["Media_Source_Netflix"] = "Netflix",
                ["Media_Source_Kino"]    = "Kinopoisk",
                ["Media_Source_Amedia"]  = "Amediateka",
                ["Media_Source_Paper"]   = "Physical book",
                ["Media_Source_Ebook"]   = "E-book",
                ["Media_Source_Audio"]   = "Audiobook",
                ["Media_Source_Cinema"]  = "Cinema",
                ["Media_Source_Other"]   = "Other",
                ["Media_StatTotal"]      = "Total entries",
                ["Media_StatYear"]       = "Completed this year",
                ["Media_StatPlanned"]    = "Planned",
                ["Media_StatDropped"]    = "Dropped",
                ["Media_StatHours"]      = "Hours watched",
                ["Media_StatTopRated"]   = "Top rated",
                ["Media_StatByType"]     = "By type",
                ["Media_StatGenre"]      = "Favourite genre",
                ["Media_StatTopGenres"]  = "Top genres",
                ["Media_OverallManual"]  = "manual",
                ["Media_ShowMore"]       = "Show more",
                ["Media_ShowLess"]       = "Collapse",
                ["Media_AutoComplete"]   = "Mark as completed?",
                ["Media_MinShort"]       = "min",
                ["Media_EpShort"]        = "ep.",
                ["Media_PageShort"]      = "p.",
                ["Media_Empty"]          = "List is empty. Press «+ Add»",

                // ── Year Statistics (Prompt 10) ───────────────────────────
                ["YearSummary_Title"]          = "{0} Year in Review",
                ["YearSummary_TabYear"]        = "Year",
                ["YearSummary_TabWeek"]        = "Week",
                ["YearSummary_ExportPdf"]      = "Export PDF",
                ["YearSummary_ExportPng"]      = "Export PNG",
                ["YearSummary_YearInActions"]  = "Year in Actions",
                ["YearSummary_HeatLess"]       = "Less",
                ["YearSummary_HeatMore"]       = "More",
                ["YearSummary_CardTasks"]      = "Tasks",
                ["YearSummary_CardFocus"]      = "Focus",
                ["YearSummary_CardEvents"]     = "Events",
                ["YearSummary_CardHabits"]     = "Habits",
                ["YearSummary_CardWorkouts"]   = "Workouts",
                ["YearSummary_CardMood"]       = "Mood",
                ["YearSummary_CardNotes"]      = "Notes",
                ["YearSummary_CardMedia"]      = "Media",
                ["YearSummary_Created"]        = "Created",
                ["YearSummary_Completed"]      = "Completed",
                ["YearSummary_CompPct"]        = "% completed",
                ["YearSummary_TopProjects"]    = "Top projects",
                ["YearSummary_TotalHours"]     = "Total hours",
                ["YearSummary_AvgPerDay"]      = "Avg per day",
                ["YearSummary_BestDay"]        = "Best day",
                ["YearSummary_BestMonth"]      = "Best month",
                ["YearSummary_ActiveHabits"]   = "Active habits",
                ["YearSummary_LongestStreak"]  = "Longest streak",
                ["YearSummary_AvgPct"]         = "Avg completion %",
                ["YearSummary_TopStable"]      = "Most stable",
                ["YearSummary_Sessions"]       = "Workouts",
                ["YearSummary_Tonnage"]        = "Tonnage",
                ["YearSummary_Favorite"]       = "Favourite exercise",
                ["YearSummary_TotalRecords"]   = "Total records",
                ["YearSummary_GreenMonth"]     = "Greenest month",
                ["YearSummary_DaysWithNotes"]  = "Days with notes",
                ["YearSummary_TopTags"]        = "Top tags",
                ["YearSummary_CompletedYear"]  = "Completed in {0}",
                ["YearSummary_AvgScore"]       = "Avg score",
                ["YearSummary_TopRated"]       = "Top rated",
                ["YearSummary_NoData"]         = "No data for this year",
                ["YearSummary_Days"]           = "d.",
                ["YearSummary_Tons"]           = "t",
                ["YearSummary_Hours"]          = "h",
                ["YearSummary_Hph"]            = "h/d",
                ["YearSummary_Of365"]          = "of {0}",
                // Day details
                ["DayStats_Title"]             = "This Day",
                ["DayStats_Tasks"]             = "✅ Tasks",
                ["DayStats_Habits"]            = "🔥 Habits",
                ["DayStats_Events"]            = "📅 Events",
                ["DayStats_Pomodoro"]          = "⏱ Pomodoro",
                ["DayStats_Workout"]           = "🏋 Workout",
                ["DayStats_Mood"]              = "😊 Mood",
                ["DayStats_Note"]              = "📝 Note",
                ["DayStats_Close"]             = "Close",
                ["DayStats_NoData"]            = "No activity found for this day",
                ["DayStats_Sessions"]          = "sessions",
                ["DayStats_Exercises"]         = "exercises",
                ["DayStats_Done"]              = "done",
                ["DayStats_Of"]               = "of",
                // Mood levels
                ["Mood_Level1"] = "Terrible",
                ["Mood_Level2"] = "Bad",
                ["Mood_Level3"] = "Neutral",
                ["Mood_Level4"] = "Good",
                ["Mood_Level5"] = "Great"
